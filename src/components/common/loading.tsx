      ...
      <style>
        {`
          ...
          #pizza-loader {
            ...
            animation: rotate-loader 45s linear infinite;
            -webkit-animation: rotate-loader 45s linear infinite;
          }

          #slice1-loader {
            animation: slice1-loader 4s ease-in-out infinite;
            -webkit-animation: slice1-loader 4s ease-in-out infinite;
          }

          #slice2-loader {
            animation: slice2-loader 4s ease-in-out infinite;
            animation-delay: 1s;
            -webkit-animation: slice2-loader 4s ease-in-out infinite;
          }

          #slice3-loader {
            animation: slice3-loader 4s ease-in-out infinite;
            animation-delay: 2s;
            -webkit-animation: slice3-loader 4s ease-in-out infinite;
          }

          #slice4-loader {
            animation: slice4-loader 4s ease-in-out infinite;
            animation-delay: 3s;
            -webkit-animation: slice4-loader 4s ease-in-out infinite;
          }

          #slice5-loader {
            animation: slice5-loader 4s ease-in-out infinite;
            animation-delay: 4s;
            -webkit-animation: slice5-loader 4s ease-in-out infinite;
          }

          #slice6-loader {
            animation: slice6-loader 4s ease-in-out infinite;
            animation-delay: 5s;
            -webkit-animation: slice6-loader 4s ease-in-out infinite;
          }
